  ...
  return (
    <main className="app-shell">
      ...
      <section className="welcome" aria-labelledby="page-title">
        <div><p className="eyebrow">CEO TODAY · V6.1.11</p><h1 id="page-title">早上好，呼总</h1><p>今天的经营重点与需要关注的事项，已为您汇总。</p></div>
        <div className="scope"><span>经营范围</span><strong>振兴 · 南山 · 航苑 · 金沙 · 网店</strong><small>历史店已排除</small></div>
      </section>

      <section className="metrics-grid" aria-label="六个核心经营指标">
