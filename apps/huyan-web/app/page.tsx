...
export default function HuyanPage() {
  ...
  const sectionMeta = activeSection !== "today" && activeSection !== "advisor" && activeSection !== "operations" && activeSection !== "products" && activeSection !== "inventory" && activeSection !== "customers" && activeSection !== "organization" ? analysisModules[activeSection] : null;
