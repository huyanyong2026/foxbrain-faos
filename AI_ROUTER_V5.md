...
AI Router V5 determines user intent, business object, required data, and required agents from a natural question.

## Example Routes
- Why profit decreased? → Finance Agent and Commerce Agent.
- Inventory risk? → Supply Agent and Forecast Engine.
- Store problem? → Store Agent and Customer Agent.
