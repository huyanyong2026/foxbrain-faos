...
<style>
*{{box-sizing:border-box}}html{{-webkit-text-size-adjust:100%;text-size-adjust:100%}}body{{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Microsoft YaHei",Arial,sans-serif;background:#f6f3ed;color:#171717;overflow-x:hidden}}
main{{width:min({max_width},calc(100% - 24px));margin:0 auto;padding:18px 0 44px;max-width:100%}}
h1{{font-size:30px;margin:8px 0 6px;line-height:1.2}}h2{{font-size:20px;margin:0 0 12px;line-height:1.28}}p,.lead{{line-height:1.65}}.lead{{font-size:16px;color:#555;margin:0 0 16px}}
...
.chat-shell{{display:grid;grid-template-columns:minmax(0,2fr) minmax(240px,1fr);gap:14px;align-items:start}}.chat-message{{border:1px solid #e4ded2;border-radius:8px;padding:14px;margin:10px 0;background:#fff}}.chat-message.user{{background:#f2f6ff;border-color:#cad8ff}}.chat-message.assistant{{background:#fbfaf7}}.chat-input{{position:sticky;bottom:0;background:#f6f3ed;padding:10px 0 4px;border-top:1px solid #e5ded2}}.chipbar{{display:flex;gap:8px;overflow:auto;padding:4px 0 8px;-webkit-overflow-scrolling:touch}}.chipbar button{{white-space:nowrap;width:auto;background:#fff;color:#1849a9;border:1px solid #cfd8ef}}.source-item{{border-top:1px solid #eee;padding:9px 0}}.confidence{{display:inline-block;border-radius:999px;background:#eef4ff;color:#1849a9;padding:5px 9px;font-weight:800}}
...
@media(max-width:820px){{main{{width:calc(100% - 16px);padding:10px 0 34px}}section{{padding:0 2px}}h1{{font-size:24px;line-height:1.22}}h2{{font-size:18px}}.lead{{font-size:14px;line-height:1.55}}.grid,.metrics,.split,.chat-shell{{grid-template-columns:1fr;gap:12px}}.panel{{padding:14px;margin:10px 0;border-radius:8px}}.card{{min-height:0;padding:14px}}.metric{{min-height:0;padding:12px}}.metric strong{{font-size:20px}}.store-row{{grid-template-columns:1fr}}.btn,button{{width:100%;padding:15px;min-height:48px}}.chipbar button{{width:auto;min-height:42px}}.topbar{{align-items:flex-start;flex-direction:column;padding:12px;position:sticky;top:0;z-index:5}}.topbar a{{margin:0 12px 0 0;display:inline-block;padding:8px 0}}table,tbody,tr,td,th{{display:block;width:100%}}thead{{display:none}}tr{{border:1px solid #eee;border-radius:8px;margin:10px 0;padding:8px;background:#fff;overflow:hidden}}td{{border:0;padding:7px 4px}}td:empty{{display:none}}.inline{{display:grid;grid-template-columns:1fr;gap:8px}}.inline form{{display:block;margin-top:0}}.pill{{border-radius:8px}}}}
