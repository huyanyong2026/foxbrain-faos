...
Procurement reviews Supply Chain Agent recommendations each morning. Store managers review store dashboards and assistant focus items before opening. CEO reviews the Huyan dashboard, daily briefing, risk radar, and decision center. Employees use WeCom AI for authorized knowledge and inventory queries.

## Health check

Confirm Core read status, AI recommendation status, Gateway route status, Huyan dashboard status, audit-log writes, and export generation.
