...
- SAP production data is read-only unless a future approved write-back workflow is explicitly designed.
- high-risk AI actions must keep human approval.
- AI output must be explainable, traceable and auditable.
- Future work must update product specification, code, tests and stage result documents together.
