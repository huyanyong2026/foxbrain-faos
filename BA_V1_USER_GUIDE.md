...
Open Supply Chain Intelligence Center, review high-priority replenishment tasks, export the replenishment report, and submit approved tasks to the normal purchasing workflow.

### CEO

Open Huyan CEO Command Center, read the daily briefing, inspect risk radar, and approve or reject decision-center actions.

### Store manager

Open Store Intelligence Center and ask: "What should Nanshan store focus today?" Review inventory risks, sales opportunities, and recommended actions.

### Employee

Ask Enterprise WeCom AI questions such as "Nanshan Osprey inventory?" The answer only includes authorized data and cites Core as the data source.
