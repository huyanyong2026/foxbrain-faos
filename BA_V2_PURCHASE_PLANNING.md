...
## Engine Output
Purchase plans combine demand forecast, current inventory, incoming inventory, supplier lead time, and safety stock into brand/product/quantity/timing recommendations.
