...
## Mission
Upgrade Enterprise WeCom into the VAFOX Employee AI Workspace without redesigning infrastructure, modifying SAP business logic, or duplicating business data.
...
- WeCom UserID maps to VAFOX Identity, role permissions, and data scope.
...
## Acceptance
PASS when a WeCom user can be recognized, mapped to VAFOX identity, and routed to role-safe AI capability.
