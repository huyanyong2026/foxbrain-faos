...
## Test Scope
Unit, AI engine, API contract, permission, integration, and forecast accuracy checks are represented by deterministic tests in tests/test_business_activation_v2_supply_chain.py.
