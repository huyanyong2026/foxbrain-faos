...
class RetrievalService:
    ...
    def vector_search(self, query, top_k, owners, tags_any=(), source=None, created_at_gte=None,
        ...
        try: points = self.qdrant.search(vector, owners, top_k, tags_any=tags_any, source=source, created_at_gte=created_at_gte, created_at_lte=created_at_lte, exclude_memory_id=exclude_memory_id, memory_id=memory_id)
