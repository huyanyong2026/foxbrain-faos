...
This stack hosts the read-only FoxBrain mirror of the SAP B1 company database.
...
- FoxBrain applications read the mirror and never write SAP production data.
- AI output, calculations and decisions stay in FoxBrain databases, not in the mirror.
