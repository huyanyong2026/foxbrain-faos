...
## Engine Output
Transfer suggestions compare all stores by SKU, on-hand inventory, sales speed, and forecast demand, then propose from-store, to-store, product, quantity, and reason.
