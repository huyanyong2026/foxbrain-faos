...
test("portal defines Chinese RBAC-protected product destinations", () => { const portal = readFileSync("apps/gateway-web/app/page.tsx", "utf8"); for (const value of ["户外生命生态", "FoxBrain企业智能", "Huyan智能经营中心", "控制中心", "employee", "ceo", "admin", "huyan.vafox.com", "ai.vafox.com", "control.vafox.com"]) assert.match(portal, new RegExp(value.replaceAll(".", "\\."))); assert.match(portal, /portal\.roles\.includes\(role\)/); });
