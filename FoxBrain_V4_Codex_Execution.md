# FoxBrain V4 企业 AI 操作系统 — Codex 执行文件

> 项目：FoxBrain / 火狐狸 AI 企业经营系统  
> 执行对象：Codex  
...
将现有 FoxBrain V3 升级为 **FoxBrain V4 企业 AI 操作系统**。

FoxBrain 不是普通后台，也不是简单知识库，而是火狐狸公司的统一 AI 经营入口。
...
把 FoxBrain 从一个内部管理门户，升级为火狐狸自己的 **AI 总经理 + 企业知识库 + 经营数据中台 + 智能体系统 + 内容发布中心**。
