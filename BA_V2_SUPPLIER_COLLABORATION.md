...
## Supplier View
Supplier collaboration exposes own brand sales, inventory status, demand forecast, and replenishment request alerts only for the supplier brand scope.
