...
AI Workforce removes agent dropdowns, object selection, data source selection, and analysis type selection. Every answer must include Conclusion, Reason, Data Source, Recommendation, and Next Action. Task drafts include task, owner, deadline, and status.
