...
## Engine Output
Each forecast contains product, store, time period, expected demand, confidence score, and reason. Factors include historical sales, inventory, product, brand, store, season, promotion, and customer trend.
