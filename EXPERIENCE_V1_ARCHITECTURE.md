# VAFOX Experience Upgrade V1.0 Architecture

## Mission
Upgrade VAFOX from multiple applications into one enterprise operating system experience without rebuilding the existing Foundation V2 services or duplicating SAP/data logic.
...
- `/experience`, `/portal-v2`, `/gateway-v2`: VAFOX Portal V2.
...
- `/design-system-v1`, `/design-system`: VAFOX Design System V1.
